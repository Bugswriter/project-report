...
\caption{\label{fig:org19b277f}NLP is subfield of AI}
\end{figure}
...
\caption{\label{fig:orga78d554}NLP functioning}
\end{figure}
...
\caption{\label{fig:org34838a3}Lojban logo}
\end{figure}
\begin{itemize}
