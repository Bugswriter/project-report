...
\caption{\label{fig:org165f5f3}NLP is subfield of AI}
\end{figure}
...
\caption{\label{fig:org1d8d20a}NLP functioning}
\end{figure}
...
\caption{\label{fig:org1ba2a7d}Lojban logo}
\end{figure}
\begin{itemize}
